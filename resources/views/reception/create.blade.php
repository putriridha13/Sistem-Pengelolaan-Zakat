            ...
            <form action="{{ route('reception.store') }}" method="post">
              ...
              <div class="card-body">
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" readonly id="no_pembayaran" name="no_pembayaran" value="{{ $no_pembayaran }}">
                  </div>
                </div>
                <div class="mb-3 row">
                  <label for="nama_muzakki" class="col-sm-2 col-form-label">Nama Muzakki</label>
                  <div class="col-sm-10">
                    <select class="form-select form-control" name="nama_muzakki" aria-label="Default select example">
              ...
              <div class="card-footer">
                <a href="/reception" class="btn btn-danger float-right mx-2">Kembali</a>
