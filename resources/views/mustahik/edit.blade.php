      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('mustahik.update', $data->id) }}" method="post">
              @csrf
              @method('PATCH')
              <div class="card-body">
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="nama" name="name" value="{{ $data->name }}">
                    @error('name')
